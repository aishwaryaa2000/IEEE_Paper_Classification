...
<?php
    ...
    include '../connect.php';
    $query_first_login="SELECT * FROM `principal_login_details` WHERE principal_user_id='$principal_user_id'";
    $res_first_login=mysqli_query($conn,$query_first_login);
    $row=mysqli_fetch_assoc($res_first_login);
    if($row['invalid']==0)
    {
      ?>
			...
			<form action="" method="POST">
				...
				<h2 class="title">Change your Password</h2>
           		...
           		<div class="input-div pass">
           		   ...
           		   <div class="div">
           		    	<h5>New Password</h5>
						   <input type="password"  onkeyup="checkPass();" class="input" title="Password must contain at least one number and one uppercase and lowercase letter, and at least 8 or more characters along with a special character" pattern="^(?=.*[a-z])(?=.*[A-Z])(?=.*[0-9])(?=.*[!@#$%^&*_=+-]).{8,30}$" name="new" id="new" required>
						   <span>
              ...
              <div class="input-div pass">
           		   ...
           		   <div class="div">
						   ...
						   <input type="password" class="input" id="confirm" onkeyup="checkPass();" name="confrim" required>
						 <br>
    ...
    <script>
		...
		function toggle(){
			if(state){
				...
				document.getElementById("new").setAttribute("type","text");
...
<?php
	...
	if(isset($_POST['submit']))
	{
		...
		if($new==$confrim)
		{	
			$query_update="UPDATE `principal_login_details` SET `password`='$hashpassword',`invalid`='1' WHERE `principal_user_id`='$principal_user_id'";
