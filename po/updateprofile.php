...
<?php
    ...
    $query_select_principal="SELECT * FROM `po_login_details` WHERE `po_user_id` = '$po_user_id'";
...
background: linear-gradient(to right, #516395, #614385); 
    ...
    .myleft_card .card-body {
      /* margin-left: 2rem;; */
      background-image: url(../Assets/SVG/po_update_profile.svg);
...
<h3 id="h3">Loading..</h3>
  ...
  <h5 class="my-0 mr-md-auto font-weight-normal">
     <img src="../Assets/logos/NSS_LOGO.png" onclick="loaddata()" width="60" height="60" class="m" alt="">  
  </h5>
  
  <nav class=" my-2 my-md-0 mr-md-3">
    <a class="p-2 text-dark" id="my"  href="index"><b>HOME</b></a>
    &nbsp;
    <a class="p-2 text-dark" id="my" href="#"><b>CHANGE PASSWORD</b></a>
    &nbsp;&nbsp;
  </nav>
          ...
          <form class="needs-validation" method="POST" action="" novalidate>
            ...
            <div class="container">
              <div class="form-group ">
                                      <input type="" type="text" name="po_name" value="<?php echo $row_details['po_name'] ?>" class="form-control" placeholder=" " id="name" required>
                                        <label for="name" >Name</label>
                            </div>
                            <br>
                            <div class="form-group ">
                                            <input type="" pattern= "[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,}$" name="po_email" value="<?php echo $row_details['po_email'] ?>" type="email" class="form-control" id="emailid" placeholder="Email ID" required>
                            ...
                            <div class="form-group ">
                                            ...
                                            <input type="text" pattern="[1-9]{1}[0-9]{9}" name="po_contact" value="<?php echo $row_details['po_contact'] ?>" class="form-control" id="con" placeholder="Contact number" required>
...
<!-- <a href="index"><button>BACK</button></a>
    ...
    <label>Name</label>
    <input type="text" name="po_name" value="<?php echo $row_details['po_name'] ?>" required><br><br> 

    <label>Email ID</label>
    <input type="text" name="po_email" value="<?php echo $row_details['po_email'] ?>" required><br><br> 

    <label>Contact</label>
    <input type="text" name="po_contact" value="<?php echo $row_details['po_contact'] ?>" required><br><br>
    ...
    if(@isset($_POST['update']))
    {
        ...
        $query_update="UPDATE `po_login_details` SET `po_name`='$po_name', `po_email`='$po_email', `po_contact`='$po_contact' WHERE `po_user_id` = '$po_user_id'";
