          ...
          <div class="card">
            ...
            <div class="card-body">
              ...
              <div class="row">
                <div class="form-group col-sm-12 col-md-4 col-xl-4">
                  <input type="" class="form-control" id="q3" onkeypress="return isNumberKey(event)" type="text"
                    name="arrA[college_telephone]" minlength="10" maxlength="11" placeholder=" "  value="<?php echo $rowA['college_telephone']; ?>" required>
              ...
              <div class="input-group mb-3">
                ...
                <input type="text" class="form-control" value="<?php echo $rowA['college_status_grant'];?>" name="arrA[college_status_grant]"  readonly>
              </div>
              <div class="input-group mb-3">
                <div class="input-group-prepend">
              ...
              <div class="input-group mb-3" id="ling" <?php echo ($rowA["college_status_minority"] != "Minority")?"style='display:none;'" : ""; ?>>
                <div class="input-group-prepend">
              ...
              <h6 style="margin-left:0.6rem;"><b>Total No's of students in Degree College</b></h6>
              <div class="row">
                <div class="form-group col-sm-12 col-md-4 col-xl-4">
                ...
                <div class="form-group col-sm-12 col-md-4 col-xl-4">
                  ...
                  name="arrA[total_student_count]" placeholder=" " value="<?php echo $rowA['total_student_count']; ?>" readonly required>
    ...
    <script type="text/javascript">
        function add() {
            ...
            if (!isNaN(result)) {
              ...
              <hr>
              <div class="form-group">
                <input type="text" name="arrA[principal_name]" pattern="[\D]+" class="form-control" id="q9" placeholder=" " value="<?php echo $rowA['principal_name']; ?>" required>
                <label for="q9" style="margin-left:0rem;">Name of the Principal</label>
              </div>
              <h6 style="margin-left:0.6rem;"><b>Contact Details</b></h6>
              <div class="row">
                ...
                <div class="form-group col-sm-12 col-md-6 col-xl-6">
                  <input type="" class="form-control" id="q12" onkeypress="return isNumberKey(event)" type="text"
                     name="arrA[principal_telephone]" maxlength="11" minlength="10" placeholder=" " value="<?php echo $rowA['principal_telephone']; ?>" required>
              ...
              <h6 style="margin-left:0.6rem;"><b>Bank A/C Details(NSS)</b></h6>
              <div class="form-group">
              ...
              <div class="form-group">
                <input type="text" name="arrA[bank_account]" class="form-control" id="q15" placeholder=" " value="<?php echo $rowA['bank_account']; ?>" required>
              ...
              <h6 style="margin-left:0.6rem;"><b>Signatories</b></h6>
              <div class="row">
                <div class="form-group col-sm-12 col-md-6 col-xl-6">
                  <input type="text" name="arrA[signatories_1]" pattern="[\D]+" class="form-control" id="q17" placeholder=" " value="<?php echo $rowA['signatories_1']; ?>" required>
                  <label for="q17" style="margin-left:1rem;">Name 1</label>
                </div>
                <div class="form-group col-sm-12 col-md-6 col-xl-6">
                  <input type="text" name="arrA[signatories_2]" pattern="[\D]+" class="form-control" id="q18" placeholder=" " value="<?php echo $rowA['signatories_2']; ?>" required>
                      ...
                      <div class="row">
                        ...
                        <div class="col-sm-12 col-md-6 col-xl-6">
                          ...
                          <div class="form-group col-sm-12 col-md-12 col-xl-12">
                            <input type="text" name="arrC_1[po_name]" pattern="[\D]+" class="form-control" id="q19" placeholder=" "
                  ...
                  <tr>
                    ...
                    <?php $rowC=mysqli_fetch_assoc($res_select_po); ?>
                      <div class="row">
                        ...
                        <div class="col-sm-12 col-md-6 col-xl-6">
                        <input type="hidden" name="po_sr[2]" value="<?php echo $rowC['sr_no']; ?>">
                          <div class="form-group col-sm-12 col-md-12 col-xl-12">
                            <input type="text" pattern="[\D]+" name="arrC_2[po_name]" class="form-control" id="q26" placeholder=" "
                    ...
                    <td>
                      <div class="row">
                        ...
                        <input type="hidden" name="po_sr[3]" value="<?php echo $rowC['sr_no']; ?>">
                          <div class="form-group col-sm-12 col-md-12 col-xl-12">
                            <input type="text" name="arrC_3[po_name]" pattern="[\D]+" class="form-control" id="q33"  placeholder=" "
                            value="<?php echo $rowC['po_name']; ?>" >
                    ...
                    <td>
                      <div class="form-group">
                        <input type="" name="arrA[prev_student_count]" class="form-control" id="q39" onkeypress="return isNumberKey(event)" type="number"
                          placeholder=" " value="<?php echo $rowA['prev_student_count']; ?>" required>
                      ...
                      <div class="form-group">
                        ...
                        value="<?php echo $rowA['prev_adopted_village']; ?>" required>
                      ...
                      <div class="row">
                        <div class="form-group col-sm-12 col-md-6 col-xl-6">
                          ...
                          value="<?php echo $rowA['prev_village_taluka']; ?>" required>
                        ...
                        <div class="form-group col-sm-12 col-md-6 col-xl-6">
                          ...
                          value="<?php echo $rowA['prev_village_district']; ?>" required>
                      ...
                      <div class="form-group">
                        ...
                        value="<?php echo $rowA['prev_student_120hrs']; ?>" required>
                      ...
                      <div class="form-group">
                        ...
                        value="<?php echo $rowA['prev_student_240hrs']; ?>" required>
                        ...
                        <div class="row">
                          ...
                          <div class="col-sm-12 col-md-6 col-xl-6">
                            <div class="form-check form-check-inline">
                              <input class="form-check-input" name="arrA[prev_audit_adopt]" value="YES" type="radio" id="inlineRadio1" <?php echo ($rowA["prev_audit_adopt"] === "YES")?"checked" : ""; ?> required>
                              <label class="form-check-label" for="inlineRadio1">YES</label>
                            </div>
                            <div class="form-check form-check-inline">
                              <input class="form-check-input" name="arrA[prev_audit_adopt]" value="NO" type="radio" id="inlineRadio2" <?php echo ($rowA["prev_audit_adopt"] === "NO")?"checked" : ""; ?> required>
                  ...
                  <tr>
                    <td>
                      <div class="form-group">
                        ...
                        value="<?php echo $rowA['prev_volunteer_camp']; ?>"  placeholder=" " required>
                      ...
                      <div class="form-group">
                        <div class="row">
                          ...
                          <div class="col-sm-12 col-md-6 col-xl-3"><input type="date" id="frmdate" onchange="setdt(this);" name="arrA[prev_starting_date_camp]" class="form-control" id="" style="padding:0rem;padding-left:1em;" value="<?php echo $rowA['prev_starting_date_camp']; ?>" required></div>
                          <div class="col-sm-12 col-md-6 col-xl-1">&nbsp;to</div>
                          <div class="col-sm-12 col-md-6 col-xl-3"><input type="date" id="todate"  name="arrA[prev_ending_date_camp]" class="form-control" id="" style="padding:0rem;padding-left:1em;" value="<?php echo $rowA['prev_ending_date_camp']; ?>" readonly required></div>
                        </div>
                      </div>
                      <script>
                                function setdt(){
                                var frmdat = document.getElementById('frmdate').value;
                                var dt = new Date(frmdat);
                                var newdtmil = dt.getTime() + 518400000 ;
                                var newdt = new Date(newdtmil);
                                ...
                                var dtsrt =  [year, month, day].join('-');
                                document.getElementById('todate').value = dtsrt;
                                  }
                              </script>
...
<div class="form-group">
                        <div class="row">
                          <div class="col-sm-12 col-md-6 col-xl-4">&nbsp;Date of the Camp, from</div>
                          <div class="col-sm-12 col-md-6 col-xl-3"><input type="text" id="datepicker1" name="arrA[prev_starting_date_camp]" class="form-control" id="" style="padding:0rem;padding-left:1em;" value="<?php echo $rowA['prev_starting_date_camp']; ?>" ></div>
                          <div class="col-sm-12 col-md-6 col-xl-1">&nbsp;to</div>
                          <div class="col-sm-12 col-md-6 col-xl-3"><input type="text" id="datepicker2"  name="arrA[prev_ending_date_camp]" class="form-control" id="" style="padding:0rem;padding-left:1em;" value="<?php echo $rowA['prev_ending_date_camp']; ?>" ></div>
                        </div>
                      </div>  -->
                      ...
                      <div class="form-group">
                        <input type="text" name="arrA[prev_venue_camp]" class="form-control" id="q46" placeholder=" " value="<?php echo $rowA['prev_venue_camp']; ?>" required >
                        <label for="q46" style="margin-left:0rem;">Venue of the Camp</label>
                      </div>
                      <div class="form-group">
                        <input type="text" name="arrA[prev_post_camp]" class="form-control" id="q47" placeholder=" " value="<?php echo $rowA['prev_post_camp']; ?>" required >
                        <label for="q47" style="margin-left:0rem;">At/Post</label>
                      </div>
                      <div class="row">
                        <div class="form-group col-sm-12 col-md-6 col-xl-6">
                          <input type="text" name="arrA[prev_taluka_camp]" class="form-control" id="q48" placeholder=" " value="<?php echo $rowA['prev_taluka_camp']; ?>" required>
                          <label for="q48" style="margin-left:1rem;">Taluka</label>
                        </div>
                        <div class="form-group col-sm-12 col-md-6 col-xl-6">
                          <input type="text" name="arrA[prev_district_camp]" class="form-control" id="q49" placeholder=" " value="<?php echo $rowA['prev_district_camp']; ?>" required>
                      ...
                      <div class="row">
                        ...
                        <div class="col-sm-12 col-md-6 col-xl-6">
                          <div class="form-check form-check-inline">
                            <input class="form-check-input" name="arrA[prev_audit_camp]" value="YES" type="radio" id="inlineRadio1"  <?php echo ($rowA["prev_audit_camp"] === "YES")?"checked" : ""; ?> required>
                            <label class="form-check-label" for="inlineRadio1">YES</label>
                          </div>
                          <div class="form-check form-check-inline">
                            <input class="form-check-input" name="arrA[prev_audit_camp]" value="NO" type="radio" id="inlineRadio2" <?php echo ($rowA["prev_audit_camp"] === "NO")?"checked" : ""; ?> required>
                            <label class="form-check-label" for="inlineRadio2">NO</label>
                          </div>
                        </div>
                      </div>
                ...
                <tr>
                  ...
                  <td>
                    ...
                    <input type="hidden" name="sl_sr[2]" value="<?php echo $rowD['sr_no']; ?>">
                      ...
                      <!-- </td><td> -->
                      <div class="form-group col-sm-12 col-md-6 col-xl-3">
                        <input type="" name="arrD_2[leader_mobile]" class="form-control" id="q56"  type="text"
                    minlength="10" maxlength="10" placeholder=" "
        ...
        <div class="card">
          ...
          <div class="card-body">
            <p><b>&nbsp;&nbsp;&nbsp;a. Every NSS volunteer must work at least 80 hours in the adopted area in two
                ...
                <tbody>
                  <tr>
                    ...
                    <td>
                      ...
                      <div class="row">
                        <div class="form-group col-sm-12 col-md-6 col-xl-6">
                          <input text="text" pattern="[\D]+" name="arrB_1[area_local_person]"  class="form-control" id="63" placeholder=" " value="<?php echo $rowB['area_local_person']; ?>" required>
                ...
                <tbody>
                  <tr>
                    ...
                    <td>
                      ...
                      <div class="row">
                        <div class="form-group col-sm-12 col-md-6 col-xl-6">
                          <input type="" type="text" name="arrB_2[area_local_person]" pattern="[\D]+" class="form-control" id="q67" placeholder=" "  value="<?php echo $rowB['area_local_person']; ?>" >
                ...
                <tbody>
                  <tr>
                    ...
                    <td>
                      ...
                      <div class="row">
                        <div class="form-group col-sm-12 col-md-6 col-xl-6">
                          <input type="text" name="arrB_3[area_local_person]" pattern="[\D]+" class="form-control" id="q70" placeholder=" " value="<?php echo $rowB['area_local_person']; ?>" >
              ...
              <div class="row">
                <div class="form-group col-sm-12 col-md-6 col-xl-6">
                  <input type="" name="arrA[sba_per_name_camp]"  pattern="[\D]+" class="form-control" id="q77"  type="text" placeholder=" "
            ...
            <table class="table table-hover table-borderless">
              ...
              <tbody>
                <tr>
                  ...
                  <td>
                    <div class="form-group">
                      <input type="text" name="arrE[name1]"  pattern="[\D]+" class="form-control" id="" placeholder=""
                ...
                <tr>
                  ...
                  <td>
                    <div class="form-group">
                      <input type="text" name="arrE[name2]"  pattern="[\D]+" class="form-control" id="" placeholder=""
                ...
                <tr>
                  ...
                  <td>
                    <div class="form-group">
                      <input type="text" name="arrE[name3]"  pattern="[\D]+" class="form-control" id="" placeholder=""
                ...
                <tr>
                  ...
                  <td>
                    <div class="form-group">
                      <input type="text" name="arrE[name4]"  pattern="[\D]+" class="form-control" id="" placeholder=""
                ...
                <tr>
                  ...
                  <td>
                    <div class="form-group">
                      <input type="text" name="arrE[name5]"  pattern="[\D]+" class="form-control" id="" placeholder=""
                ...
                <tr>
                  ...
                  <td>
                    <div class="form-group">
                      <input type="text" name="arrE[name6]"  pattern="[\D]+" pattern="[A-Za-z\s]+" class="form-control" id="" placeholder=""
                ...
                <tr>
                  ...
                  <td>
                    <div class="form-group">
                      <input type="text" name="arrE[name7]"  pattern="[\D]+" class="form-control" id="" placeholder=""
                ...
                <tr>
                  ...
                  <td>
                    <div class="form-group">
                      <input type="text" name="arrE[name8]"  pattern="[\D]+" class="form-control" id="" placeholder=""
                ...
                <tr>
                  ...
                  <td>
                    <div class="form-group">
                      <input type="text" name="arrE[name9]"  pattern="[\D]+" class="form-control" id="" placeholder=""
    ...
    <div class="row">
      ...
      <div class="col-sm-12">
        <div class="card">
          ...
          <div class="card-body">
            <p style="margin-left:0.6rem;"><b>Suggestion</p></b>
            <div class="form-group">
            ...
            <div class="row">
              <div class="col-sm-12 col-md-6 col-xl-3">
                          <div class="input-group mb-3">
                            ...
                            value="<?php echo $rowA['date_application']; ?>" required>
                          </div>
              </div>
              ...
              <div class="col-sm-12 col-md-6 col-xl-3"> 
                          ...
                          <div class="input-group mb-3">
                            ...
                            value="<?php echo $rowA['place_application']; ?>" required >
                          </div>
              </div>
              ...
              <br>
                        <div class ="row">
                                <div class="col-sm-12 col-md-6 col-xl-6" style="margin-left:1rem;">
                                  <p><img id="output"  <?php if($rowA['img1']!=''){ echo 'src="data:image/*;base64,'.base64_encode($rowA['img1']).'"';}?> class="pic" width="250" height="150"/></p>
                                  <p><input type="file"  accept=" .jpg " name="image" id="file" style="display: none;" onchange="loadFile(event)" <?php if($rowA['img1']==''){ echo 'required' ;} ?>></p>
                                ...
                                <div class="col-sm-12 col-md-12 col-xl-12" style="margin-left:1rem;">                                 
                                  <p><img id="outputsign" <?php if($rowA['img2']!=''){ echo 'src="data:image/*;base64,'.base64_encode($rowA['img2']).'"';}?> class="pic" width="250" height="150" /></p>
                                  <p><input type="file" accept=" .jpg " name="imagei" id="filei" style="display: none;" onchange="loadFilei(event)" <?php if($rowA['img2']==''){ echo 'required' ;} ?>></p>
                ...
                <div class="d-flex justify-content-center">
                   <button type="submit" class="mybtn" name="update" id="f20" value="Update" style="border-radius: 24px;">Update</button>
                </div>
                  <?php 
                          }
                          else{
