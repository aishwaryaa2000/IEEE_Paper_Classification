            ...
            <div class="card-body">
              ...
              <div class="row">
                <div class="form-group col-sm-12 col-md-4 col-xl-4">
                  <input type="" class="form-control" id="q3"  pattern="[0-9]{10,11}" type="text"
              ...
              <h6><b>Status of the College</b></h6>
    ...
    <script type="text/javascript">
        function add() {
            ...
            if (!isNaN(result)) {
              ...
              <div class="form-group">
                <input type="text" name="arrA[principal_name]" pattern="[\D]+" class="form-control" id="q9" placeholder=" " required>
              ...
              <div class="form-group">
                <input  class="form-control" onkeypress="return isNumberKey(event)" type="text"  maxlength="20" name="arrA[bank_account]"  id="q15" placeholder=" " required>
              ...
              <div class="row">
                <div class="form-group col-sm-12 col-md-6 col-xl-6">
                  <input type="text" name="arrA[signatories_1]" pattern="[\D]+" class="form-control" id="q17" placeholder=" " required>
                  <label for="q17" style="margin-left:1rem;">Name1</label>
                </div>
                <div class="form-group col-sm-12 col-md-6 col-xl-6">
                  <input type="text" name="arrA[signatories_2]" pattern="[\D]+" class="form-control" id="q18" placeholder=" " required>
                      ...
                      <div class="row">
                        ...
                        <div class="col-sm-12 col-md-6 col-xl-6">
                          ...
                          <div class="form-group col-sm-12 col-md-12 col-xl-12">
                            <input type="text" name="arrC_1[po_name]" pattern="[\D]+" class="form-control" id="q19" placeholder=" " required>
                    ...
                    <td>
                      ...
                      <div class="row">
                        ...
                        <div class="col-sm-12 col-md-6 col-xl-6">
                          ...
                          <div class="form-group col-sm-12 col-md-12 col-xl-12">
                            <input type="text" name="arrC_2[po_name]" pattern="[\D]+" class="form-control" id="q26" placeholder=" " >
                    ...
                    <td>
                      ...
                      <div class="form-group">
                        <div class="row">
                          ...
                          <div class="col-sm-12 col-md-6 col-xl-3"><input type="date" id="frmdate" onchange="setdt(this);" style="padding:0rem;padding-left:0.5em;" name="arrA[prev_starting_date_camp]" class="form-control" required></div>
                          <div class="col-sm-12 col-md-6 col-xl-1">&nbsp;to</div>
                          <div class="col-sm-12 col-md-6 col-xl-3"><input type="date" id="todate" style="padding:0rem;padding-left:0.5em;" name="arrA[prev_ending_date_camp]" class="form-control" required readonly></div>
                        </div>
                      </div>
                              <script>
                                function setdt(){
          ...
          <div class="card-body">
            <p><b>&nbsp;&nbsp;&nbsp;a. Every NSS volunteer must work at least 80 hours in the adopted area in two
                ...
                <tbody>
                  <tr>
                    ...
                    <td>
                      ...
                      <div class="row">
                        <div class="form-group col-sm-12 col-md-6 col-xl-6">
                          <input type="text" name="arrB_1[area_local_person]" pattern="[\D]+" class="form-control" id="q63" placeholder=" " required>
                ...
                <tbody>
                  <tr>
                    ...
                    <td>
                      ...
                      <div class="row">
                        <div class="form-group col-sm-12 col-md-6 col-xl-6">
                          <input type="text" name="arrB_2[area_local_person]" pattern="[\D]+" class="form-control" id="q67" placeholder=" " >
                ...
                <tbody>
                  <tr>
                    ...
                    <td>
                      ...
                      <div class="row">
                        <div class="form-group col-sm-12 col-md-6 col-xl-6">
                          <input type="text" name="arrB_3[area_local_person]" pattern="[\D]+" class="form-control" id="q70" placeholder=" " >
              ...
              <div class="form-group">
                ...
                <label for="q73" style="margin-left:0rem;">Name of the village or slum</label>
              </div>
              ...
              <div class="row">
                <div class="form-group col-sm-12 col-md-6 col-xl-6">
                  <input type="" name="arrA[sba_per_name_camp]" class="form-control" id="q77" pattern="[\D]+" type="text" placeholder=" " required>
            ...
            <table class="table table-hover table-borderless">
              ...
              <tbody>
                <tr>
                  ...
                  <td>
                    <div class="form-group">
                      <input type="text" name="arrE[name1]" pattern="[\D]+" class="form-control" id="" placeholder=" " required>
                    </div>
                  </td>
                  <td>
                    <div class="form-group">
                ...
                <tr>
                  ...
                  <td>
                    <div class="form-group">
                      <input type="text" name="arrE[name2]" pattern="[\D]+" class="form-control" id="" placeholder=" " required >
                    </div>
                  </td>
                  <td>
                    <div class="form-group">
                ...
                <tr>
                  ...
                  <td>
                    <div class="form-group">
                      <input type="text" name="arrE[name3]" pattern="[\D]+" class="form-control" id="" placeholder="" required>
                    </div>
                  </td>
                  <td>
                    <div class="form-group">
                ...
                <tr>
                  ...
                  <td>
                    <div class="form-group">
                      <input type="text" name="arrE[name4]" pattern="[\D]+" class="form-control" id="" placeholder="" required>
                    </div>
                  </td>
                  <td>
                    <div class="form-group">
                ...
                <tr>
                  ...
                  <td>
                    <div class="form-group">
                      <input type="text" name="arrE[name5]" pattern="[\D]+" class="form-control" id="" placeholder="" required>
                    </div>
                  </td>
                  <td>
                    <div class="form-group">
                ...
                <tr>
                  ...
                  <td>
                    <div class="form-group">
                      <input type="text" name="arrE[name6]" pattern="[\D]+" class="form-control" id="" placeholder="" required>
                    </div>
                  </td>
                  <td>
                    <div class="form-group">
                ...
                <tr>
                  ...
                  <td>
                    <div class="form-group">
                      <input type="text" name="arrE[name7]" pattern="[\D]+" class="form-control" id="" placeholder="" required>
                    </div>
                  </td>
                  <td>
                    <div class="form-group">
                ...
                <tr>
                  ...
                  <td>
                    <div class="form-group">
                      <input type="text" name="arrE[name8]" pattern="[\D]+" class="form-control" id="" placeholder="" required>
                    </div>
                  </td>
                  <td>
                    <div class="form-group">
                ...
                <tr>
                  ...
                  <td>
                    <div class="form-group">
                      <input type="text" name="arrE[name9]" pattern="[\D]+" class="form-control" id="" placeholder="" required>
                    </div>
                  </td>
                  <td>
                    <div class="form-group">
    ...
    <div class="row">
      ...
      <div class="col-sm-12">
        <div class="card">
          ...
          <div class="card-body">
            <p style="margin-left:0.6rem;"><b>Suggestion</b>
                <div class="form-group">
                  <input type="text" name="arrA[suggestion_improve]" class="form-control" id="q79" 
                    placeholder=" " required>
                    <label for="q79" id="f15" style="margin-left:0rem;"><b>a. To improve the efficiency of N.S.S Activities</b></label>
                </div>
                <div class="form-group">
                  <input type="text" name="arrA[expectation]" class="form-control" id="q80" placeholder=" " required>
                  <label for="q80" id="f16"  style="margin-left:0rem;"><b>b. Expectation from University NSS cell</b></label>
                </div>
            ...
            <div class="row">
              <div class="col-sm-12 col-md-6 col-xl-3">
                          <div class="input-group mb-3">
                            ...
                            <input type="date" id="app_dt" name="arrA[date_application]" class="form-control" placeholder="Username" aria-label="Username" aria-describedby="basic-addon1" readonly required>
                            <script type="text/javascript">
                            n =  new Date();
                            month1 = '' + (n.getMonth() + 1),
                                  day1 = '' + n.getDate(),
                                ...
                                if (day1.length < 2) 
                                  day1 = '0' + day1;
                                var n_val =  [year1, month1, day1].join('-');
                                console.log(n_val);
                            document.getElementById("app_dt").value = n_val;
                            </script>                          
                      </div>
              </div>
              ...
              <br>
                        <div class ="row">
                                  ...
                                  <p><input type="file" accept=" .jpg " name="image" id="file"  onchange="loadFile(event)" style="display: none;"  required></p>
                                ...
                                <div class="col-sm-12 col-md-12 col-xl-12" style="margin-left:1rem;">  
                                  ...
                                  <p><input type="file" accept=" .jpg " name="imagei" id="filei"  onchange="loadFilei(event)" style="display: none;" required></p>
                   ...
                   <button type="save" name="save" onclick="removeRequired(this.form)" value="save" class="mybtn" style="border-radius: 24px;">Save</button>
