...
<body>
    ...
    <h3>Contact Details Of Parent/Guardian</h3>
    <a href="guardiandetails">open</a>
    <br>
    <h3>Consolidated Statistical Information</h3>
    <a href="consolidatedstatisticalinformation">open</a>
    <br>
    <h3>Volunteer Contact and Address Details</h3>
    <a href="volunteercontact">open</a>
    <br>
    <h3>sample</h3>
    <a href="#">open</a>
    <br>
   ...
   <a href="index"><button class="btn btn-primary">&nbsp;&nbsp;&nbsp;Back&nbsp;&nbsp;&nbsp;</button></a>
    ...
    <div class="row pt-5">
      <div class="col-md-2"></div>
        ...
        <a class="card1" href="guardiandetails" id="link">
<h3>Contact Details Of Parent/Guardian</h3>

<p class="small">View the contact details of the Parent/Guardian of all the students of the respective colleges</p>
<div class="go-corner" >
<div class="go-arrow">
→
</div>
        ...
        <div class="col-md-4 sm-12">
                    <a class="card1" href="volunteercontact" id="link" style="background: #A770EF;  
background: -webkit-linear-gradient(to right, #FDB99B, #CF8BF3, #A770EF);  
background: linear-gradient(to right, #FDB99B, #CF8BF3, #A770EF); ">
                    <h3>Volunteer Contact and Address Details</h3>
                    
                    <p class="small">View the contact details of all the sudents of the respective colleges</p>
                    <div class="go-corner">
                    <div class="go-arrow">
                    →
                    </div>
    ...
    <!-- <div class="row">
        ...
        <div class="col-md-4">
                    <a class="card1" href="pobasicdetails" id="link" style="background: #BE93C5;  
background: -webkit-linear-gradient(to right, #7BC6CC, #BE93C5);  
background: linear-gradient(to right, #7BC6CC, #BE93C5); ">
        ...
        <div class="col-md-4">
                    <a class="card1" href="adoptedareafront" id="link" style="background: #A770EF;  
background: -webkit-linear-gradient(to right, #FDB99B, #CF8BF3, #A770EF);  
background: linear-gradient(to right, #FDB99B, #CF8BF3, #A770EF); ">
    ...
    <div class="row">
        ...
        <div class="col-md-4">
                    <a class="card1" href="#" id="link" style="background: #BE93C5;  
background: -webkit-linear-gradient(to right, #7BC6CC, #BE93C5);  
background: linear-gradient(to right, #7BC6CC, #BE93C5); ">
