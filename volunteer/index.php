...
<?php
    ...
    include '../connect.php';
    $query_first_login="SELECT * FROM `volunteer_user_id_po` WHERE vol_user_id='$vol_user_id'";
			...
			<form action="firstlogin" method="POST">
				...
				<h3 class="title">CHANGE YOUR PASSWORD</h3>
           		...
           		<div class="input-div pass">
           		   ...
           		   <div class="div">
           		    	<h5>New Password</h5>
						   <input type="password" onkeyup="checkPass();" class="input" pattern="^(?=.*[a-z])(?=.*[A-Z])(?=.*[0-9])(?=.*[!@#$%^&*_=+-]).{8,30}$" title="Password must contain at least one number and one uppercase and lowercase letter, and at least 8 or more characters along with a special character" name="new" id="new" required>
						   <span>
              ...
              <div class="input-div pass">
           		   ...
           		   <div class="div">
						   ...
						   <input type="password" onkeyup="checkPass();" class="input" id="confirm2" name="confrim" required>
