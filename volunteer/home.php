...
<head>
  ...
  <style>   
    .myCard{
        background-image: url(../Assets/SVG/w_welcome_volB.svg),url(../Assets/SVG/w_welcome_volT.svg);
        background-repeat: no-repeat;
        background-size: cover;
    }
    .my_sub_card1{
        background-image: url(../Assets/SVG/w_vol1.svg);
        background-repeat: no-repeat;
        background-size: cover;
    }
    .mybtn{
  ...
  <a class="btn btn-info" style="background-color: #4A529D" href="../logout">LOGOUT</a>
    ...
    <div class="jumbotron bg-light p-4 p-md-5 rounded myCard shadow-sm">
        <div class="col-md-6 px-0">
          ...
          <p class="lead my-3 text-white"><strong>Hello, <?php echo $vol_nm ?></strong></p>
      ...
      <div class="row mb-2">
        ...
        <div class="col-md-6">
          <div class="row no-gutters border rounded overflow-hidden flex-md-row mb-4 myshadow h-md-250 position-relative my_sub_card1">
            <div class="col p-4 d-flex flex-column position-static">
              ...
              <p class="card-text mb-auto">Profile Details</p>
              <div class="d-flex justify-content-center">
              <a href="performa2update" class="mybtn btn btn-primary" role="button">Click here</a>
            </div>            
          </div>
        </div>
        </div>
        ...
        <div class="col-md-6">
          <div class="row no-gutters border rounded overflow-hidden flex-md-row mb-4 myshadow h-md-250 position-relative my_sub_card1">
            <div class="col p-4 d-flex flex-column position-static">
              <!-- <strong class="d-inline-block mb-2 text-primary">NSS</strong> -->
              <h3 class="mb-0">Class Predictor</h3>
              <br>
              <!-- <div class="mb-1 text-muted">Nov 12</div> -->
              <p class="card-text mb-auto">Predict the class of the paper using abstract.</p>
              <div class="d-flex justify-content-center">
              <a href="performa2update" class="mybtn btn btn-primary" role="button">Click here</a>
            </div>            
          </div>
