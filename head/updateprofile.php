...
<?php
    ...
    $query_select_head="SELECT * FROM `head_details` WHERE `head_user_id` = '$head_user_id'";
    $res_select=mysqli_query($conn,$query_select_head);
...
<div class="container" style="margin-top: 2rem;">
          ...
          <form class="needs-validation" method="POST" action="" novalidate>
            ...
            <div class="container">
              <div class="form-group ">
                                      <input type="text" name="head_name" pattern="[A-Za-z\s]+" value="<?php echo @$row_details['name'] ?>" class="form-control" placeholder=" " id="name" required>
                                        <label for="name" >Name</label>
                            </div>
                            <br>
                            <div class="form-group ">
                                            <input type="email" pattern= "[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,}$" name="head_email" value="<?php echo @$row_details['email_id'] ?>" class="form-control" id="emailid" placeholder=" " required>
                            ...
                            <div class="form-group ">
                                            ...
                                            <input type="text" onkeypress="return isNumberKey(event)" name="head_contact" value="<?php echo @$row_details['contact'] ?>" maxlength="10" minlength="10" class="form-control" id="con" placeholder=" " required>
    ...
    if(@isset($_POST['update']))
    {
        ...
        $query_update="UPDATE `head_details` SET `name`='$head_name', `email_id`='$head_email', `contact`='$head_contact' WHERE `head_user_id` = '$head_user_id'";
