...
<head>
    ...
    <title>Contact Details of the Principal:</title>
    <style>
/*        
                button.mybtn {
      display: block;
...
<div class="jumbotron">
    <ul class="navbar font-weight-bold mynav2">
              <li class="nav-item list-unstyled col-sm-4 md-4 xl-6">
                <div class="nav-link text-white text-center mylabels">Contact Details of the Principal</div>
              </li>
              <li class="nav-item  list-unstyled col-sm-4 md-4 xl-6">
    ...
    <tr>
    <th><b>Sr.No.</b></th>
    <th><b>Name of the Principal </b></th>
    <th><b>Mobile Number</b></th>
    <th><b>Landline Number</b></th>
    <th><b>Email id </b></th>
       </tr>
    </thead>
    <tbody>
...
if (mysqli_num_rows($result) > 0){
     while ($data = mysqli_fetch_assoc($result)) {
        echo '<tr>';       
        echo '<td>'.$srno.'</td>';
        echo '<td>'.$data['principal_name'].'</td>';
        echo '<td>'.$data['principal_mobile'].'</td>';
        echo '<td>'.$data['principal_telephone'].'</td>';
        echo '<td>'.$data['principal_email'].'</td>';
        echo '</tr>';
        $srno += 1;
        }
}
