...
<img class="wave" src="../Assets/img/wave7.png">
	<div class="container">
		<div class="img">
			<img src="../Assets/SVG/prin_change_pwd.svg">
		</div>
			...
			<form method="POST">
                ...
                <br>
           		...
           		<div class="input-div pass">
           		   ...
           		   <div class="div">
           		    	<h5>New Password</h5>
           		    	<input type="password" class="input" id="password2"  onkeyup="checkPass();" name="new_password" required>
...
<input type="submit" name="change" value="Update Password">
    ...
    if(@isset($_POST['change']))
    {
        ...
        $query_check="SELECT * FROM `head_details` WHERE `head_user_id`='$head_user_id' and `password`='$old_password'";
        $res_check=mysqli_query($conn,$query_check);
        if(mysqli_num_rows($res_check)>0)
        {
            if($new==$confirm)
            {
                $query_update="UPDATE `head_details` SET `password`='$new_password' WHERE `head_user_id`='$head_user_id'";
